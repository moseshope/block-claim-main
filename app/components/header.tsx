...
export default function Header() {
    ...
    return (
        <header className={isOpen ? 'absolute flex flex-col items-center transition-height duration-1000 ease-in-out h-full bg-[#161616]': 'relative'} style={headerStyle}>
            <div 
                className={
                    isOpen ? 
                        'flex justify-between items-center h-fit mt-[30px] gap-6' : 
                        'flex justify-between items-center px-5 py-4 border border-[#161616]'}>
            ...
            <div className='relative mt-6'>
                {
                    isOpen ?
                    <div className='relative right-[0px] flex flex-col px-4 py-4 text-2xl text-[#fbfbfb]'>
